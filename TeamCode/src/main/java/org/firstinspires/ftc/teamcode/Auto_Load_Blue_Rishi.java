...
@Autonomous(name="Auton Load Blue Rishi")
public class Auto_Load_Blue_Rishi extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        trajectoryActionBuilder = drive.actionBuilder(_beginPos)
    ...
    private TranslationalVelConstraint GetTranslationalVelConstraint(){
        return new TranslationalVelConstraint(50);
    }

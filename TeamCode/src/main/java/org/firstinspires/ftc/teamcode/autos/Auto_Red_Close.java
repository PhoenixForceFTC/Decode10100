...
@Autonomous(name="4 Auto Red Close")
...
/*    VelConstraint slowVelConstraint = new MinVelConstraint(Arrays.asList(
    ...
    public void runOpMode() throws InterruptedException {
        ...
        _robot.limelightHardware2Axis.setServos(0.6,0.5);
...
//                //clear gate
                .strafeToSplineHeading(new Vector2d(-2, -45), Math.toRadians(-90), fastVelConstraint, fastAccelConstraint)
                .strafeToSplineHeading(new Vector2d(-2, -57), Math.toRadians(-90), fastVelConstraint, fastAccelConstraint)
                .waitSeconds(0.3)
//                //.turn(Math.PI/3)

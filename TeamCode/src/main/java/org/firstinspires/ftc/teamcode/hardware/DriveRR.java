...
public class DriveRR
{
    ...
    public void arcadeDriveSpeedControl()
    {
        ...
        mecanumDrive.setDrivePowers(new PoseVelocity2d(new Vector2d(_gamepad.left_stick_y*speedMultiplier, _gamepad.left_stick_x*speedMultiplier ), _gamepad.right_stick_x*speedMultiplierRotate));
        if (_showInfo)
        {
